...
import com.dantas.demo.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	// Esta anotation resolve a dependencia do Testconfig com o userRepository para
	// poder usar a instancia do userRepository
	@Autowired
